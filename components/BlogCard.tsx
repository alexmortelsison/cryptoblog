...
const BlogCard = ({ post }: { post: BlogTypeCard }) => {
  ...
  return (
    <li className="border border-muted-foreground dark:border-white rounded-lg hover:border-primary hover:text-primary hover:scale-105 hover:duration-300 duration-300 shadow-md dark:shadow-lg shadow-slate-500 dark:shadow-slate-400 mb-8">
